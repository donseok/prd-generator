...
const LAYERS = [
  {
    ...
    ring: "ring-[#6366F1]/25",
    surface: "bg-[#6366F1]/5 border-[#6366F1]/15",
  },
  {
    key: "normalizing",
    name: "요구사항 정규화",
    ...
    ring: "ring-[#8B5CF6]/25",
    surface: "bg-[#8B5CF6]/5 border-[#8B5CF6]/15",
  },
  {
    key: "validating",
    name: "검증 및 리뷰 분기",
    ...
    ring: "ring-[#F59E0B]/25",
    surface: "bg-[#F59E0B]/5 border-[#F59E0B]/15",
  },
  {
    key: "generating",
    name: "문서 생성",
    ...
    ring: "ring-[#10B981]/25",
    surface: "bg-[#10B981]/5 border-[#10B981]/15",
  },
];
        ...
        aside={
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900">{progress}%</p>
            </div>
            <div className="h-2.5 overflow-hidden rounded-full bg-slate-200">
              <div className="h-full rounded-full bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] transition-all duration-500" style={{ width: `${progress}%` }} />
            </div>
            {status ? (
                ...
                return (
                  <div
                    ...
                    className={`rounded-2xl border p-5 transition ${
                      isCurrent
                        ? `${layer.surface} ring-2 ${layer.ring}`
                        : isComplete
                    ...
                    <div className="flex items-start gap-4">
                      <div
                        className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl text-white ${
                          isComplete ? "bg-gradient-to-br from-emerald-500 to-teal-600" : isCurrent ? layer.accent : "bg-slate-300"
                        }`}
                      >
                        {isCurrent ? (
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center justify-between gap-3">
                          <p className="text-base font-semibold tracking-tight text-slate-900">{layer.name}</p>
                          <span
          ...
          <aside className="section-card">
              ...
              {status.documents?.length ? (
                status.documents.map((document) => (
                  <div key={document} className="surface-muted flex items-center gap-3 px-4 py-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-slate-500 to-slate-600 text-white">
            ...
            <div className="mt-6 grid gap-4">
              ...
              <div className="surface-muted p-5">
                ...
                <div className="mt-3 flex items-center gap-2 text-sm font-medium text-[#6366F1]">
